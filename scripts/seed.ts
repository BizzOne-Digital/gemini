...
async function seed() {
  ...
  if (serviceCount === 0) {
    const services = [
      ...
      { title: "Bakery & Desserts", slug: "bakery", shortDescription: "Fresh pies and made-from-scratch desserts", fullDescription: "Our bakery features homemade pies, cakes, and desserts baked fresh using traditional family recipes.", image: "/images/service-bakery.png", imageAlt: "Homemade chocolate cake and bakery desserts at Homestyle Diner", ctaLabel: "View Desserts", ctaHref: "/menu?category=bakery-desserts", displayOrder: 3, isFeatured: true },
      ...
      { title: "Catering", slug: "catering", shortDescription: "Homemade food for your next event", fullDescription: "Let us cater your office meeting, family gathering, or special celebration with our homestyle menu options.", image: "/images/service-catering.jpg", imageAlt: "Catering spread with fresh salads and appetizers", ctaLabel: "Request Catering", ctaHref: "/booking?type=catering", displayOrder: 6, isFeatured: true },
      { title: "Group Dining", slug: "group-dining", shortDescription: "Perfect for teams, families, and celebrations", fullDescription: "Planning a group meal? We welcome parties and can accommodate your group with advance notice.", image: "/images/service-group-dining.png", imageAlt: "Elegant group dining experience at Homestyle Diner", ctaLabel: "Book Group Dining", ctaHref: "/booking?type=group_dining", displayOrder: 7 },
    ];
    ...
    await PageContent.insertMany([
      {
        ...
        pageTitle: "Home",
        sections: [
          { key: "hero", eyebrow: "Family Owned in Waterloo Since 1987", heading: "Homemade Comfort Food, Served with Heart.", description: "From hearty breakfasts to slow-cooked favourites and freshly baked pies, enjoy the flavours of home in the heart of Waterloo.", ctaLabel: "Explore Our Menu", ctaHref: "/menu", ctaSecondaryLabel: "Order Online", ctaSecondaryHref: "#order", isVisible: true, displayOrder: 0 },
          { key: "welcome", heading: "A Waterloo Tradition Since 1987", description: "Homestyle Diner is a family-owned and operated restaurant in Waterloo, Ontario, serving the community since 1987. The restaurant specializes in homemade comfort food prepared with recipes passed down through generations.", ctaLabel: "Discover Our Story", ctaHref: "/about", isVisible: true, displayOrder: 1 },
          ...
          { key: "bakery", heading: "Fresh From Our Bakery", description: "Homemade pies and made-from-scratch desserts baked daily using traditional family recipes.", ctaLabel: "View Desserts", ctaHref: "/menu?category=bakery-desserts", isVisible: true, displayOrder: 4 },
