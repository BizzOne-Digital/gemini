  ...
  if (navCount === 0) {
    await Navigation.create({
      links: [
        ...
        { label: "Gallery", href: "/gallery", displayOrder: 3, isVisible: true, openInNewTab: false },
        { label: "Services", href: "/services", displayOrder: 4, isVisible: true, openInNewTab: false },
        { label: "Booking", href: "/booking", displayOrder: 5, isVisible: true, openInNewTab: false },
        { label: "Contact", href: "/contact", displayOrder: 6, isVisible: true, openInNewTab: false },
      ],
    ...
    await PageContent.insertMany([
      {
        ...
        pageTitle: "Home",
        sections: [
          { key: "hero", eyebrow: "Family Owned in Waterloo Since 1987", heading: "Homemade Comfort Food, Served with Heart.", description: "From hearty breakfasts and lunches to slow-cooked dinners, homestyle favourites, and freshly baked pies, enjoy the flavours of home in the heart of Waterloo.", image: "/images/hero-breakfast.jpg", imageAlt: "Hearty homestyle breakfast at Homestyle Diner", ctaLabel: "See What's Cooking", ctaHref: "/menu", ctaSecondaryLabel: "Book a Table", ctaSecondaryHref: "/booking", isVisible: true, displayOrder: 0 },
